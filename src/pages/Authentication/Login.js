...
console.log(values);
    ...
    values
      ...
      .then(function (response) {
        ...
        localStorage.setItem("authUser", JSON.stringify({'uid':response.data.data.id, 'username':response.data.data.username, 'role':'admin', 'email':response.data.data.email, 'accessToken':response.data.data.accessToken }));
            ...
            <Col md={8} lg={6} xl={5}>
                  ...
                  <Row>
                    <Col xs={7}>
                      <div className="text-primary p-4 pe-1">
                        ...
                        <p>Sign in to continue to Aurres.</p>
                      </div>
                    </Col>
              ...
              <div className="mt-5 text-center">
                ...
                <p>
                  ...
                  Design & Develop by Block Tech Brew
                </p>
              </div>
            </Col>
          </Row>
