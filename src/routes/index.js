...
import AdminCoinIcon from "../admin/icon/index"
import AdminTransactions from "../admin/transactions/index"
import AdminTransactionsDetail from "../admin/transactions/detail"
import AdminWallet from "../admin/wallet/index"
...
const authProtectedRoutes = [
  ...
  { path: "/admin/icon", component: AdminCoinIcon },
  { path: "/admin/transactions", component: AdminTransactions },
  { path: "/admin/transaction/:date", component: AdminTransactionsDetail },
  { path: "/admin/wallet", component: AdminWallet },
